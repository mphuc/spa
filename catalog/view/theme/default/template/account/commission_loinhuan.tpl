     ...
     <div class="row">
        ...
        <div class="col-md-12">
           <!-- col-md-12 start here -->
             <h3 class="text-center" style="color: #7d3c93">Lịch sử hoa hồng chia lợi nhuận chuỗi spa</h3>
                <table class="table display dataTable table-bordered table_member">
                  <thead>
                    <tr class="header">
                      ...
                      <th>Số dư ví chia lợi nhuận chuỗi spa</th>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td data-title="Số dư ví chia lợi nhuận chuỗi spa"><?php echo number_format($value['balance']);?> VNĐ</td>
