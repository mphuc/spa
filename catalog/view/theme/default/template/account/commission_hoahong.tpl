     ...
     <div class="row">
        ...
        <div class="col-md-12">
           <!-- col-md-12 start here -->
             <h3 class="text-center" style="color: #7d3c93">Lịch sử hoa hồng thu nhập trực tiếp của F1</h3>
                <table class="table display dataTable table-bordered table_member">
                  <thead>
                    <tr class="header">
                      ...
                      <th>Số dư ví thu nhập trực tiếp của F1</th>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td data-title="Số dư ví thu nhập trực tiếp của F1"><?php echo ($value['balance']/1000);?> ĐT</td>
