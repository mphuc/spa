                ...
                <div class="panel-body p0">
                    ...
                    <div class="col-md-6 col-md-offset-3 mb10">
                        <div class="btn-group btn-group-vertical">
                          <div class="controls">
                             <form id="frmunlock" method="GET" action="<?php echo $self->url->link('account/block/unlock', '', 'SSL'); ?>">
                                      <input type="hidden" name="unlock" value="<?php echo $block_status ?>">
