     ...
     <div class="row">
        ...
        <div class="col-md-12">
           <!-- col-md-12 start here -->
             <h3 class="text-center" style="color: #7d3c93">Lịch sử hoa hồng đồng chia tổng doanh số</h3>
                <table class="table display dataTable table-bordered table_member">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td data-title="Số dư ví tổng doanh số"><?php echo number_format($value['balance']);?> VNĐ</td>
