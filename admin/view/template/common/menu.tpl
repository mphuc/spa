...
<li id="dashboard"><a href="index.php?route=pd/customer&token=<?php echo $_GET['token'];?>"><i class="fa fa-dashboard fa-fw"></i> <span>Thành viên</span></a></li>
...
<li id="system"><a class="parensts"><i class="fa fa-cog fa-fw"></i> <span>Kế toán</span></a>
  <ul>
    ...
    <li><a href="index.php?route=pd/ketoan/ketoan_ch&token=<?php echo $_GET['token'];?>" class="parensts">Hoa hồng cộng hưởng</a></li>
