...
<div class="container-fluid">
  <div class="panel panel-default">
    <div class="panel-heading">
      <h3 class="panel-title pull-left">Hoa hồng cộng hưởng</h3>
          ...
          <tr>
            ...
            <td class="text-center">
              <?php if ($value['status'] == 1) { ?>
                <a href="index.php?route=pd/ketoan/up_ch&token=<?php echo $_GET['token'];?>&id=<?php echo $value['id'] ?>&status=0" onclick="return confirm('Bạn chắc chắn không?');">
                  <i class="fa fa-circle" aria-hidden="true" style="color: #4CAF50" title="Đã thanh toán"></i>
                </a>
              <?php } else { ?>
                <a href="index.php?route=pd/ketoan/up_ch&token=<?php echo $_GET['token'];?>&id=<?php echo $value['id'] ?>&status=1" onclick="return confirm('Bạn chắc chắn không?');">
